...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/letterfade.js":[function(require,module,exports) {
"use strict";
...
var letterFade = function letterFade(txtList) {
  for (var i = 0; i < txtList.length; i++) {
    ...
    stringToFade = stringToFade.slice(0, -4) + '<span class="cut">' + stringToFade.substring(stringToFade.length - 4) + '</span>';
    txtList[i].innerHTML = stringToFade;
  }
};

exports.letterFade = letterFade;
},{}],"src/main.js":[function(require,module,exports) {
"use strict";

var _letterfade = require("./letterfade.js");
